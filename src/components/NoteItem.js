    ...
    <>
        ...
        <div className="solution_card">
          ...
          <div className="solu_description">
            <p className="description">
              <img alt='open' src={open} className='img mx-3 my-4' onClick={() => { viewNotes(note._id); ref1.current.click() }} />
              <img alt='edit' src={edit} className='img mx-3 my-4' onClick={() => { updateNote(note) }} />
              <img alt='delete' src={Delete} className='img mx-3 my-4' onClick={() => { deleteNote(note._id); props.showAlert('Note Deleted Successfully', 'success') }} />
            </p>
            <button type="button" className="read_more_btn">Note #{props.index + 1}</button>
          </div>
        </div>
      </div>
      ...
      <div className="modal fade w-100" id="exampleModal1" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-1">
          <div className="modal-content w-75 m-auto text-center">
            <div className="modal-header">
              <h5 className="modal-title " id="exampleModalLabel">{view.title}</h5>
              <button type="button" className="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body text-center" dangerouslySetInnerHTML={{ __html: view.description }} />
            <div className="modal-footer">
              <button type="button" className="button-22" data-bs-dismiss="modal">Close</button>
            </div>
